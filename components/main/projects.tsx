...
export const Projects = () => {
  return (
    <section
      id="projects"
      className="flex flex-col items-center justify-center py-20 min-h-screen bg-[#030014] relative overflow-hidden"
    >
      {/* Background overlay */}
      ...
      <div className="relative z-10 w-full max-w-7xl">
        ...
        >
          <div className="Welcome-box py-[8px] px-[7px] border border-[#7042f88b] opacity-90 inline-flex items-center mb-8">
        ...
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 px-8"
        >
        ...
        >
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-500 to-cyan-500 text-white font-medium rounded-lg hover:from-purple-600 hover:to-cyan-600 transition-all duration-300"
          >
            View More on GitHub
          </motion.a>
        </motion.div>
